    ...
    <div class="container">
        <div class="list">
            ...
            <select id="produtos" size="10" multiple>
                ...
                <option value="<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="buttons">
